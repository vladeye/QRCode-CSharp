...
{
	[Activity (Label = "ZXing.BarCode", MainLauncher = true, ConfigurationChanges=ConfigChanges.Orientation|ConfigChanges.KeyboardHidden)]
	public class Activity1 : Activity
	{
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			buttonScanDefaultView.Click += delegate {
				...
				scanner.TopText = "Hold the camera up to the bar code\nAbout 6 inches away";
				scanner.BottomText = "Wait for the bar code to automatically scan!";
		...
		void HandleScanResult (ZXing.Result result)
		{
			...
			if (result != null && !string.IsNullOrEmpty(result.Text))
				msg = "Found Bar Code: " + result.Text;
			else
